		...
		<div class = "loginbox">
			...
			<center>
				<?php
					...
					echo '<h1 style = "margin-bottom: 50px; ">DO YOU WANT TO CANCEL THE REQUEST?</h1>';
				?>
					<button class = 'approved' onclick = "location.href='cancel_form.php?formid=<?php echo "$formid"; ?>'">YES</button>
				
					nbspnbspnbsp
					<button class = "reject" onclick = "location.href='status.php'">NO</button>

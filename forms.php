		...
		<div class = "register">
			...
			<table>
				...
				<?php
					...
					$view = "SELECT * FROM forms WHERE username = '$username' ORDER BY date_requested DESC";
					...
					else
					{
						while ( $record = mysql_fetch_assoc($result))
						{
							...
							echo '<tr>';
								...
								{
								echo "<button type = 'button' class = 'reject' ><a href =\"yesornocancel.php?formid={$record['formid']}\">CANCEL REQUEST</a></button>";
								}
							echo '</td></tr>';
						}
					}

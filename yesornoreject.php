		...
		<div class = "loginbox">
			...
			<center>
				<?php
					...
					echo '<h1 style = "margin-bottom: 50px; ">DO YOU WANT TO REJECT THE REQUEST?</h1>';
				?>
					<button class = 'approved' onclick = "location.href='reject_form.php?formid=<?php echo "$formid"; ?>'">YES</button>

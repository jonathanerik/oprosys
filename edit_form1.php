...
<body>
	...
	<div class="main-body">
		...
		<div class = "register">
			<div class = "back">
				<button type = "button" class = "submit"><?php echo "<a href =\"view_approve.php?formid={$formid}\">◄ BACK</button></a>"; ?>
			...
			?>
				...
				<table>
						...
						<tr>
							<td colspan = 2 ><input type ="text" readonly = "" value = "CHANGES ACCEPTED!"></td>
						</tr>

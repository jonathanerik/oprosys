		...
		<div class = "register">
			...
			?>
				<table>
						...
						<tr>
							<td><?php echo "<button type = 'button' class = 'approved'><a href =\"yesorno.php?formid={$formid}&comments={$comments}\">APPROVE</button></a>"; ?></td>
							<td><?php echo "<button type = 'button' class = 'reject' ><a href =\"yesornoreject.php?formid={$record['formid']}\">REJECT</a></button>"; ?></td>
						</tr>
						<tr>
							<td colspan = 2 ><?php echo "<button type = 'button' class = 'details'><a href =\"edit_form.php?formid={$formid}\">EDIT</a></button>"; ?></td>
						</tr>
				</table>
			<?php
			}
			...
			?>
				<table>
						...
						<tr>
							<td><?php echo "<button type = 'button' class = 'approved'><a href =\"yesorno.php?formid={$formid}&recommendations={$recommendations}\">APPROVE</button></a>"; ?></td>
							<td><?php echo "<button type = 'button' class = 'reject'><a href =\"yesornoreject.php?formid={$formid}\">REJECT</button></a>"; ?></td>
						</tr>
						<tr>
							<td colspan = 2 ><?php echo "<button type = 'button' class = 'details'><a href =\"edit_form.php?formid={$formid}\">EDIT</button></a>"; ?></td>
						</tr>
				</table>
			<?php
			}
			...
			?>
				<table>
						...
						<tr>
							<td><?php echo "<button type = 'button' class = 'approved'><a href =\"yesorno.php?formid={$formid}\">APPROVE</button></a>"; ?></td>
							<td><?php echo "<button type = 'button' class = 'reject'><a href =\"yesornoreject.php?formid={$formid}\">REJECT</button></a>"; ?></td>
						</tr>
				</table>
			<?php
